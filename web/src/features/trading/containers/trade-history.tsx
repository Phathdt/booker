import { useGetTrades } from "@/core/api/generated/market/market";
...
export function TradeHistory({ pairId }: TradeHistoryProps) {
  const { data, isLoading } = useGetTrades(pairId, undefined, { query: { refetchInterval: 5000, enabled: Boolean(pairId) } });
